...
// Đăng nhập (Demo mode - Static Site)
async function login(email, password) {
  console.warn('⚠️ Static Site Mode: Mock login');
  ...
  try {
    ...
    setAuthToken(mockToken, mockUser);
...
// Đăng ký (Demo mode - Static Site)
async function signup(name, email, password, phone = "") {
  console.warn('⚠️ Static Site Mode: Mock signup');
